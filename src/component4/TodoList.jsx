...
const TodoList = () => {
  ...
  useEffect(() => {
    const fetchTodoData = async () => {
      try {
        const response = await axios.get('https://6479fed2a455e257fa642b32.mockapi.io/items');
  ...
  const handleAddTodo = async () => {
    ...
    try {
      const response = await axios.post('https://6479fed2a455e257fa642b32.mockapi.io/items', newTodo);
  ...
  const handleEditTodo = async (id, updatedTodo) => {
    ...
    try {
      await axios.put(`https://6479fed2a455e257fa642b32.mockapi.io/items/${id}`, updatedTodo);
  ...
  const handleDeleteTodo = async () => {
    ...
    try {
      await axios.delete(`https://6479fed2a455e257fa642b32.mockapi.io/items/${todoToDelete.id}`);
